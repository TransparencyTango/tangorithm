    ...
    if gloveExplorer and req:
        ...
        if match is not None:
            ...
            mirror.current_similarities = \
                gloveExplorer.getSimilarities(["socialism","social","sozial-democratic","feminist","reformist","liberal","feminist","Tory","communist","coalition","progressiv","conservative","centre-left","Whing","Protestant","libertarian","successfully","ultimately","efficiently","effectually","frequently","actively","lose","fail","relinquish","finish","take away","forfeit","loved","loyalty","joy","spirit","hope","enthusiasm","hated","lust","cruelty","cruel","spite","distrust","procreate","psychically","spouce","stilborn","nurture","criminal","suicidal","maid","waitress","receptionist","nurse","midwife","nanny","housekeeper","hostess","gynecologist","socialite","undertaker","referee","actor","coach","president","plumber","announcer","maestro","janitor","professor","doctor","assistant"])
            return "ok"
        else:
            mirror.reset_mirror()
