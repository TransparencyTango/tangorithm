    ...
    if gloveExplorer and req:
        ...
        if match is not None:
            ...
            mirror.current_similarities = \
                gloveExplorer.getSimilarities(["socialism","liberal","conservative","successfull","loved","hated","procreate","criminal","suicidal","nurse","president","professor","assistant","victim"])
            return "ok"
        else:
            mirror.reset_mirror()
